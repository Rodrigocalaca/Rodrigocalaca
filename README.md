...
(EN/US) Although almost all of my git repos are using python, I'm actually focusing at C# wpf development, using it at my current fulltime job. Python was my entrance to programming. Nowadays, I feel more confident with C# than with Python, but with enought focus and study I can handle any language at all. Feel free to get in touch using my contacts below
